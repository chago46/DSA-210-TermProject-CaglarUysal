...
def run_data_collection(tee):
    ...
    try:
        ...
        try:
            from data_collection_new import main as collect_main
        except ImportError:
...
def run_hypothesis_testing(tee):
    ...
    try:
        from hypothesis_testing import main as hyp_main
...
def check_outputs(tee):
    ...
    expected_outputs = [
        ...
        ('data/processed/admissions_merged.csv', 'Merged Dataset'),
    ]
