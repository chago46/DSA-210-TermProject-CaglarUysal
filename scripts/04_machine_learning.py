...
January 2nd Submission

This script applies comprehensive machine learning techniques to predict graduate admission outcomes:
...
- Stacking Classifier (Ensemble) - Best Model

UNSUPERVISED LEARNING:
- K-means Clustering to identify applicant groups
...
5. Ensemble methods (Voting and Stacking)
6. Clustering analysis to identify applicant segments
7. Comprehensive visualizations
8. Model persistence for future predictions
...
def load_data():
    ...
    possible_paths = [
        Path('data/processed/final_combined_dataset.csv'),
        Path('data/processed/merged_data_combined.csv'),
        Path('final_combined_dataset.csv'),  # Fallback for old structure
        Path('merged_data_combined.csv')      # Fallback for old structure
    ]
    ...
    raise FileNotFoundError("Could not find dataset. Expected: data/processed/final_combined_dataset.csv")
...
def train_all_models(X, y):
    ...
    print("Training 5 base models + 2 ensemble methods")
    print("="*60)
    ...
    # 1. Random Forest
    print("\n[1/7] Training Random Forest Classifier...")
    rf_param_grid = {
    ...
    print("\n[4/7] Training Linear Regression (converted to classification)...")
    ...
    print("\n[5/7] Training Neural Network (MLPClassifier)...")
    ...
    print("\n[6/7] Training Voting Classifier (Soft Voting)...")
    ...
    # Stacking Classifier
    print("\n[7/7] Training Stacking Classifier...")
